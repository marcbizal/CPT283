...
<html>
	<head>
		<meta charset="utf-8">
		<title>Bob’s Entertainment SuperSite Order Total</title>
	</head>
	<body>
		<?php
			...
			include "setup.php";
		?>
		<h1>Bob’s Entertainment SuperSite <? echo $department; ?> Order Total</h1>
		<p>Thank you for shopping on Bob’s Entertainment SuperSite, we appreciate your business!</p>
		<?php
					$id_str = implode(",", $ID);
